...
BEGIN
    ...
    "POWERBUTTON_IRQ_AP"                      : NODE_NUM = 650 ;
    "CPU_D3"                                  : OUTPUT_PIN = 40 ;
    "DTACK_TIMER_1"                           : NODE_NUM = 652 ;
    "CPU_D2"                                  : OUTPUT_PIN = 39 ;
    "AS_GATED"                                : NODE_NUM = 654 ;
    "REFRESH_TIMER0"                          : NODE_NUM = 655 ;
    ...
    "DEBUG_INT_AP"                            : NODE_NUM = 662 ;
    "DTACK_TIMER_0"                           : NODE_NUM = 663 ;
    "CPU_UDS"                                 : INPUT_PIN = 33 ;
    "REFRESH_STATE_TIMER2"                    : NODE_NUM = 664 ;
    "CPU_D5"                                  : OUTPUT_PIN = 44 ;
    "KEYBOARDIRQ_AR"                          : NODE_NUM = 666 ;
    "CPU_D6"                                  : OUTPUT_PIN = 45 ;
    "IRQL6B_AP"                               : NODE_NUM = 668 ;
    "CPU_D7"                                  : OUTPUT_PIN = 46 ;
    "XXL_391"                                 : NODE_NUM = 670 ;
    "XXL_400"                                 : NODE_NUM = 671 ;
    "IRQL4A_AP"                               : NODE_NUM = 672 ;
    "IRQL6A_AP"                               : NODE_NUM = 673 ;
    "XXL_398"                                 : NODE_NUM = 674 ;
    "XXL_393"                                 : NODE_NUM = 675 ;
    "XXL_403"                                 : NODE_NUM = 676 ;
    "RESET_REQ_OUT"                           : NODE_NUM = 677 ;
    "XXL_395"                                 : NODE_NUM = 678 ;
    "XXL_392"                                 : NODE_NUM = 679 ;
    "DTACK_FROM_INT"                          : OUTPUT_PIN = 52 ;
    "XXL_394"                                 : NODE_NUM = 681 ;
    "XXL_411"                                 : NODE_NUM = 682 ;
    "DRAM_CS"                                 : INPUT_PIN = 54 ;
    "XXL_407"                                 : NODE_NUM = 683 ;
    "XXL_408"                                 : NODE_NUM = 684 ;
    "INTC_CS"                                 : INPUT_PIN = 55 ;
    "XXL_415"                                 : NODE_NUM = 685 ;
    "CPU_INTACK2"                             : INPUT_PIN = 56 ;
    "XXL_399"                                 : NODE_NUM = 686 ;
    "XXL_406"                                 : NODE_NUM = 687 ;
    "CPU_INTACK1"                             : INPUT_PIN = 57 ;
    "XXL_412"                                 : NODE_NUM = 688 ;
    "XXL_397"                                 : NODE_NUM = 689 ;
    "XXL_401"                                 : NODE_NUM = 690 ;
    "CPU_INTACK0"                             : INPUT_PIN = 58 ;
    "XXL_396"                                 : NODE_NUM = 691 ;
    "XXL_404"                                 : NODE_NUM = 692 ;
    "KEYBOARDIRQSIGNAL"                       : INPUT_PIN = 60 ;
    "XXL_409"                                 : NODE_NUM = 693 ;
    "XXL_402"                                 : NODE_NUM = 694 ;
    "XXL_410"                                 : NODE_NUM = 695 ;
    "TCK"                                     : INPUT_PIN = 62 ;
    "XXL_405"                                 : NODE_NUM = 696 ;
    ...
    "CAS3"                                    : OUTPUT_PIN = 70 ;
    "CLK_8M"                                  : NODE_NUM = 710 ;
    "XXL_416"                                 : NODE_NUM = 711 ;
    "TDO"                                     : INPUT_PIN = 71 ;
    "XXL_413"                                 : NODE_NUM = 712 ;
    "RAS2"                                    : OUTPUT_PIN = 73 ;
    "DEBUG_INT"                               : NODE_NUM = 716 ;
    "RAS0"                                    : OUTPUT_PIN = 74 ;
    "POWERCTL_STATE"                          : OUTPUT_PIN = 75 ;
    "KEYBOARDIRQ"                             : NODE_NUM = 719 ;
    "POWERBUTTON_IRQ"                         : NODE_NUM = 721 ;
    "IRQL6B"                                  : NODE_NUM = 722 ;
    "IRQL6A"                                  : NODE_NUM = 724 ;
    "XXL_417"                                 : NODE_NUM = 727 ;

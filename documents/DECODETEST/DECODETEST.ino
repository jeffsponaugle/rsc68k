/*
  ...
  Device Hookup:
  PG = PG0=CLK_32(out) NOT USED, PG1=CLK_16(out) Pin[83],PG2=RESET(out) Pin[84], PG5=NOT USED 
  PA = DATABUS0-7 - Used this test: D3-D0(PA3-0) on [Pins 11,10,9,8]
  PC = DATABUS 8-15 Not used this test.
  PF = ADDRESSBUS 7-0 Not used this test.
  PL = ADDRESSBUS 15-8 (PL7-0) = [Pin 28,29,30,31,33,34,35,36]
  PK = ADDRESSBUS 23-16 (PK7-0) = [Pin 17,18,20,21,22,24,25,27]
  PE = PE5,4,3=FC2-0 (PE5,4,3) = [Pin 37,39,40]
  ...
  SEVENSEG_LATCH_CS = XXFF00XX
  UART_CSA = XXFF01XX
  UART_CSB = XXFF02XX
  IDE_CSA = XXFF03XX
  IDE_CSB = XXFF04XX
  LED_LATCH_CS = XXFF05XX
  RTS_CS = XXFF85XX 
  PTC_CS = XXFF8AXX
  NIC_CS = XXFF88XX
  SPY_SETUP_LATCH_CS = XXFF82XX
  WORKER_RESET_PRESENCE_LATCH_CS = XXFF80XX
  WORKER_BARRIER_CS = XXFF89XX
  K8042_CS = XXFF84XX
  ITC_CS = XXFF07XX

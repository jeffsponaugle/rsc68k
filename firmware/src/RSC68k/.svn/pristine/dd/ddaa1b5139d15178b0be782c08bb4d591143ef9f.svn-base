...
/* Assume top of stack for supervisor CPU */
	...
	lea	RSC68KHW_SUPERVISOR_ISA_IO, %a0
...
UARTTestScratch:
	moveb	#0xa5, %d0
	moveb	%d0, (UART_REG_SCR << 1)(%a6)
	moveb	(UART_REG_SCR << 1)(%a6), %d0
	cmpi	#0xa5, %d0
	beq	UARTTestScratch2

/* Failed scratch register test */
	HALT

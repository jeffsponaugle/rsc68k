...
_vectorTable:
	...
	.long	BootLoaderEntry + RSC68KHW_SUPERVISOR_FLASH	/* 1   - PC startup vector */
...
SendHex:
	...
	lea	BinaryToHex + RSC68KHW_SUPERVISOR_FLASH, %a5
...
/* Now we start the copy of our code to the base RAM and check it */
	...
	lea	RSC68KHW_SUPERVISOR_FLASH, %a0
	lea	RSC68KHW_BASE_RAM, %a1
...
DRAMFault:
	dc.b	0x0d 
	dc.b	0x0a
	.ascii	"Flash->RAM readback fault at address 0x"
	dc.b	0x00
...
HeapTestCheckFailed:
	lea	HeapFault + RSC68KHW_SUPERVISOR_FLASH, %a5
...
/* Flash->RAM Readback fault at address */
	...
	lea	DRAMFault + RSC68KHW_SUPERVISOR_FLASH, %a5
	StacklessCall	SendString
...
/* Expected */
	...
	lea	DRAMFault2 + RSC68KHW_SUPERVISOR_FLASH, %a5
	StacklessCall	SendString
...
/* Got */
	...
	lea	DRAMFault3 + RSC68KHW_SUPERVISOR_FLASH, %a5
	StacklessCall	SendString
...
/* CR/LF */
	lea	DRAMFault4 + RSC68KHW_SUPERVISOR_FLASH, %a5
	StacklessCall	SendString
	HALT

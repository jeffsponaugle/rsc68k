...
extern void FlashPageWriteSet(uint8_t u8Value);
extern void FlashPageReadSet(uint8_t u8Value);
extern void FlashPageRAMWriteSet(void);
extern void FlashPageRAMReadSet(void);
